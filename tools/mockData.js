...
const beasts = [
    {
        ...
        attackOptions: 'Fangs (melee) +5 (1d6 + 1 plus poison).' + newRow + 'Poison The target must make a Strength challenge roll with 1 bane.' + 
        ...
        specialAttacks: '',
        specialActions: 'Pinning Gaze The amphisbaena uses a triggered action on its turn to fix its gaze on one target creature within medium range of it.' + 
        'The target must make a will challange roll. On a failure, it becomes immobilized until it uses an action to remove the affliction.' + 
    ...
    },
    {
        ...
        traits: 'Multitude A swarm takes half damage from effects that use an attack roll and double damage from effects that require it to challenge roll.' + newRow + 
